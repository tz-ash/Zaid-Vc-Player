...
💭 **[{BOT_NAME}](https://t.me/{BOT_USERNAME}) 𝗮𝗹𝗹𝗼𝘄 𝘆𝗼𝘂 𝘁𝗼 𝗽𝗹𝗮𝘆 𝗺𝘂𝘀𝗶𝗰 𝗼𝗻 𝗴𝗿𝗼𝘂𝗽𝘀 𝘁𝗵𝗿𝗼𝘂𝗴𝗵 𝘁𝗵𝗲 𝗻𝗲𝘄 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺'𝘀 𝘃𝗼𝗶𝗰𝗲 𝗰𝗵𝗮𝘁𝘀 𝐩𝐨𝐰𝐞𝐫𝐞𝐝 𝐛𝐲 𝐊𝐢𝐝 !**
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "💝 ᴅᴇᴠʟᴏᴘᴇʀ", url=f"https://t.me/kidhub")
                ],[
                    InlineKeyboardButton(
                        "👥 ᴏꜰꜰɪᴄɪᴀʟ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/tzkid"
                    ),
                    InlineKeyboardButton(
...
async def cbhelp(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b>💡 Hello there, welcome to the help menu Powered by @kidbots !</b>
...
⚡ __Powered by {BOT_NAME} A.I__""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🏡ᴋɪᴅ ʙᴀᴄᴋ", callback_data="cbguide"
                    )
                ]
            ]
        )
...
⚡ __Powered by {BOT_NAME} ᴋɪᴅ__""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🏡 ᴋɪᴅ ʙᴀᴄᴋ", callback_data="cbstart"
                    )
                ]
            ]
        )
